    ...
    <div className="flex flex-col h-full bg-slate-50/50 dark:bg-slate-950 transition-colors">
      <header className="h-16 md:h-20 bg-white/80 dark:bg-slate-950/80 backdrop-blur-md border-b border-slate-200/50 dark:border-slate-800/50 px-4 md:px-8 flex items-center shrink-0 transition-colors sticky top-0 z-10 gap-4">
        ...
        <h1 className="text-xl md:text-2xl font-bold tracking-tight text-slate-900 dark:text-slate-100 flex items-center gap-3 font-sans">
           <div className="w-8 h-8 rounded-xl bg-blue-50 dark:bg-blue-900/40 text-blue-500 flex items-center justify-center">
             <Folder className="w-5 h-5" />
           </div>
           All Items
        </h1>
        <div className="ml-auto hidden sm:flex items-center text-sm font-bold text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-slate-800 px-4 py-1.5 rounded-full tracking-wide">
      ...
      <div className="flex-1 overflow-y-auto p-4 md:p-8">
        <div className="max-w-4xl mx-auto flex flex-col gap-6 pb-10">
          <div className="sm:hidden flex items-center text-sm font-bold text-slate-500 dark:text-slate-400 bg-white border border-slate-200 px-4 py-2 rounded-full tracking-wide w-fit dark:bg-slate-900 dark:border-slate-800">
